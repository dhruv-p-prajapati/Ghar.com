      ...
      <div class="py-12 px-5 flex justify-center">
        <div class="flex flex-col md:flex-row items-center justify-center md:px-10">
          <div class="md:w-1/2 md:mr-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">List Your Property for Free</h2>
          ...
          <div class="md:w-1/3">
            <img src="/images/BasicDetails.gif" alt="Add Property" class="w-[350px] rounded-lg shadow-md" />
          </div>
        </div>
      </div>

      <div class="py-12 px-5 flex justify-center">
        <div class="flex flex-col md:flex-row-reverse items-center justify-center md:px-10">
          <div class="md:w-1/2 md:mr-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Manage Your Listings with Ease</h2>
            <p class="text-gray-700 mb-4">
          ...
          <div class="md:w-1/3">
            <img src="/images/PropertyDetail.gif" alt="Builder Management" class="w-[350px] rounded-lg shadow-md" />
          </div>
        </div>
      </div>
    </div>
