...
import { BookConfirmationModel, Button, DeleteConfirmationPropertyModel, HelmetHeader, VerifyUnverifyConfirmationModel } from "../../common";
...
const PropertyDetail = () => {
  ...
  return (
    <>
      <HelmetHeader title={property?.name || "Property Detail"} />
